...
public class Historic {
	...
	public Historic clone() {
		Historic cloned = new Historic(historicLeft, historicRight);
		cloned.setLength(length);
		cloned.setRightItem(rightItem);
		cloned.setLeftItem(leftItem);
		if (dominoLeft != null) {
			cloned.setDominoLeft(dominoLeft.cloneNoMatrix());
		}
		if (dominoRight != null) {
			cloned.setDominoRight(dominoRight.cloneNoMatrix());
		}
		if (historicLeft != null) {
			cloned.setHistoricLeft(historicLeft.clone());
		}
		if (historicRight != null) {
			cloned.setHistoricRight(historicRight.clone());
		}
		return cloned;
	}

	public Historic(String treeHistoric) {
		if (treeHistoric != null) {
	...
	public String getTreeFormat() {
		if (this.historicLeft == null || this.historicRight == null) {
			return Historic.separatorLeft + this.leftItem + Historic.itemSeparator + this.rightItem
					+ Historic.separatorRight;
		}
		return Historic.separatorLeft + this.historicLeft.getTreeFormat() + Historic.itemSeparator
				+ this.historicRight.getTreeFormat() + Historic.separatorRight;
	}
	...
	private void setHistoric(String left, String right) throws IllegalArgumentException {
		if (left == null || left.trim().equals("")) {
			throw new IllegalArgumentException(
					"Invalid argument.\nThe Historic" + " on the Left attribute is null, void or invalid");
		}

		if (right == null || right.trim().equals("")) {
			throw new IllegalArgumentException(
					"Invalid argument.\nThe Historic" + " on the Right attribute is null, void or invalid");
		}
	...
	public void addHistoric(Historic historic) throws IllegalArgumentException {
		if (historic == null || historic.toString().toString() == null
				|| historic.toString().toString().trim().equals("")) {
			throw new IllegalArgumentException("Invalid argument.\nThe Historic" + " attribute is null or void");
		}
...
//        }
	 ...
	 * 
	 * <p>
	 * <b>Exemple:</b> <blockquote>suppose the historic [[A,B],[C,D]]. To the index:
	 * <br>
	 * 1 => A <br>
	 * 2 => B <br>
	 * 3 => C <br>
	...
	public Dominoes getDominoLeft() {
		return dominoLeft;
	}

	public void setDominoLeft(Dominoes dominoLeft) {
		this.dominoLeft = dominoLeft;
	}

	public Dominoes getDominoRight() {
		return dominoRight;
	}

	public void setDominoRight(Dominoes dominoRight) {
		this.dominoRight = dominoRight;
	}
	...
	public void setHistoricLeft(Historic historicLeft) {
		this.historicLeft = historicLeft;
	}

	public void setHistoricRight(Historic historicRight) {
		this.historicRight = historicRight;
	}
