...
public interface MatrixOperations {
	...
	public static MatrixOperations configureOperation(CRSMatrix matrix, MatrixDescriptor descriptor, boolean isSparse) throws Exception {
		MatrixOperations mat = MatrixOperationsFactory.getMatrix2D(Configuration.processingUnit, descriptor, isSparse);
