...
public class SortRowsCommand extends AbstractCommand {
	...
	public SortRowsCommand() {
		this.index = -1;
	}

	public SortRowsCommand(int index) {
		this();
		this.index = index;
	}
	...
	public String getName() {
		return SORT_ROW_COMMAND + "(" + this.oldDominoes.getId() + ")";
	}
	private String id;
