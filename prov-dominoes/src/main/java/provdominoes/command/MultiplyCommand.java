...
public class MultiplyCommand extends AbstractCommand {
	...
	protected boolean doIt() {
		...
		if (App.getArea().getData().getCombination() == PieceCanvasState.COMBINATION_MULTIPLICATION && App.getArea().getData().getIndexFirstOperatorCombination() != -1
			...
			try {
				...
				App.alertException(e, "Error trying to perform piece combination through matrix multiplication!");
				result = false;
				e.printStackTrace();
			}
		}
