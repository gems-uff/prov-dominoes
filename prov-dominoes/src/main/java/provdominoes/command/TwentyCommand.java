...
public class TwentyCommand extends AbstractCommand {
	...
	public TwentyCommand() {
		this.index = -1;
	}

	public TwentyCommand(int index) {
		this();
		this.index = index;
	}
	...
	protected boolean doIt() {
		...
		try {
			...
			Dominoes domino = provdominoes.control.Controller.twenty(toInvert);
			...
			App.alertException(e, "Erro desconhecido ao efetuar filtro de 20% maiores!");
			e.printStackTrace();
			success = false;
		}
	...
	public String getName() {
		return TWENTY_COMMAND + "(" + this.oldDominoes.getId() + ")";
	}
	private String id;
