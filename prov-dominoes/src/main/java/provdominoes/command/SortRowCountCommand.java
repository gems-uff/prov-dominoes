...
public class SortRowCountCommand extends AbstractCommand {
	...
	public SortRowCountCommand() {
		this.index = -1;
	}

	public SortRowCountCommand(int index) {
		this();
		this.index = index;
	}
	...
	public String getName() {
		return SORT_ROW_COUNT_COMMAND + "(" + this.oldDominoes.getId() + ")";
	}
	private String id;
